...
export default function CountdownTimer() {
  ...
  if (departed) {
    return (
      <div className="text-center py-6">
        <p className="text-3xl font-bold" style={{ color: '#FFB300', fontFamily: 'Bangers, cursive', letterSpacing: '2px' }}>
          TO INFINITY!
        </p>
        <p className="text-white/60 text-sm mt-1 font-semibold">旅程已開始，玩得開心！🚀</p>
      </div>
    )
  }
  ...
  return (
    <div className="text-center animate-fade-in">
      ...
      <p className="text-xs text-white/40 mt-4 font-semibold">
        2026年5月20日 08:50 出發 🚀
      </p>
    </div>
  )
